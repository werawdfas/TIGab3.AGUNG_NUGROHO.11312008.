...
<?php
    ...
    if (tep_not_null($product_info['products_model'])) {
      $products_name = $product_info['products_name'] . ' <span style="font-size:10px;">[' . $product_info['products_model'] . ']</span>';
    } else {
...
<?php echo tep_draw_form('cart_quantity', tep_href_link(FILENAME_PRODUCT_INFO, tep_get_all_get_params(array('action')) . 'action=add_product')); ?>
  ...
  <h1><?php echo $products_name; ?> <span style="float: right;"><?php echo $products_price; ?></span></h1>
...
?>
    ...
    <div id="piGal">
      <p style="text-align:center"> <?php echo '<a href="' .  DIR_WS_IMAGES . $product_info['products_image'] . '" target="_blank" rel="fancybox">' . tep_image(DIR_WS_IMAGES . $product_info['products_image'], addslashes($product_info['products_name']), SMALL_IMAGE_WIDTH*1.5, SMALL_IMAGE_HEIGHT*1.5,'hspace="5" vspace="5"') . '</p><p class="box_link" style="text-align:center">' . TEXT_CLICK_TO_ENLARGE . '</p></a>'; ?>
    </div>
