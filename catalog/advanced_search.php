...
<div class="contentContainer">
  ...
  <div class="contentText">
    ...
    <div id="helpSearch" title="<?php echo HEADING_SEARCH_HELP; ?>" style=" background: #fff;border:1px solid #595959; -moz-border-radius: 3px; -webkit-border-radius: 3px; border-radius: 3px;">
