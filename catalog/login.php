...
<div class="contentContainer"  style="height:240px;">
<?php
...
<div  style="width: 45%; float: left;">
  ...
  <div class="contentText">
    ...
    <p align="right" style="margin-top:43px;"><span><?php echo tep_draw_button(IMAGE_BUTTON_CONTINUE, 'triangle-1-e', tep_href_link(FILENAME_CREATE_ACCOUNT, '', 'SSL')); ?></span></p>
  </div>
</div>

<div style="width: 45%; float: left; border-left: 1px dashed #ccc; padding-left: 3%; margin-left: 3%;">
  ...
  <div class="contentText">
    ...
    <p><?php echo '<a href="' . tep_href_link(FILENAME_PASSWORD_FORGOTTEN, '', 'SSL') . '">' . TEXT_PASSWORD_FORGOTTEN . '</a>'; ?>

    <span style="float:right"><?php echo tep_draw_button(IMAGE_BUTTON_LOGIN, 'key', null, 'primary'); ?></span></p>
